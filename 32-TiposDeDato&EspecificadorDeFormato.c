//Tipos de datos Básicos y especificador de formato dentro de printf
#include <stdio.h>
...
//El tamaño y el tipo de datos que almacenará la variable
/*
...
//Especificadores de formato básicos (printf)
/*
